...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <DockPanel Margin="12">
        ...
        <Grid>
            <Grid.RowDefinitions><RowDefinition Height="2.5*"/><RowDefinition Height="Auto"/><RowDefinition Height="1*"/></Grid.RowDefinitions>
            <ScrollViewer Grid.Row="0" VerticalScrollBarVisibility="Auto" Padding="0,0,8,0">
                <StackPanel>
                    ...
                    <Border Background="White" CornerRadius="8" Padding="10" Margin="0,0,0,8" BorderBrush="#E2E8F0" BorderThickness="1">
                        <StackPanel>
                            ...
                            <UniformGrid Columns="2" VerticalAlignment="Top">
                                ...
                                <CheckBox Name="ChkBackupAll" Content="Rút Toàn bộ Driver máy" IsChecked="False" FontWeight="Bold" Margin="0,0,0,6" FontSize="12"/>
                                <CheckBox Name="ChkBackupNet" Content="Chỉ rút Driver LAN/Wi-Fi" IsChecked="True" Foreground="#D97706" FontWeight="Bold" Margin="0,0,0,6" FontSize="12"/>
                                ...
                                <CheckBox Name="ChkUltraView" Content="Tải &amp; Bật UltraView" IsChecked="True" Foreground="#0284C7" FontWeight="Bold" FontSize="12" Margin="0,0,0,6"/>
                                
                                <CheckBox Name="ChkWifi" Content="Lưu Pass &amp; Tên Wi-Fi" IsChecked="True" Foreground="#D97706" FontWeight="Bold" FontSize="12"/>
                                <CheckBox Name="ChkAnyDesk" Content="Tải AnyDesk" IsChecked="False" FontSize="12"/>
                            </UniformGrid>
                        </StackPanel>
                    </Border>
                    ...
                    <Border Background="#F1F5F9" CornerRadius="8" Padding="12" Margin="0,0,0,2" BorderBrush="#CBD5E1" BorderThickness="1">
                        <StackPanel>
                            <TextBlock Text="4. WINDOWS OPTIMIZER &amp; BLOATWARE:" FontWeight="Bold" Foreground="#0F172A" Margin="0,0,0,10"/>
                            <UniformGrid Columns="3" VerticalAlignment="Top">
                                <CheckBox Name="ChkBloatware" Content="Gỡ Bloatware (Giữ cơ bản)" IsChecked="True" FontSize="11" FontWeight="Bold" Margin="0,0,0,6"/>
